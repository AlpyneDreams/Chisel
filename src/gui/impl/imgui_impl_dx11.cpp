...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    {
        if (bd->pd3dDevice->CreateVertexShader(g_vs_main, sizeof(g_vs_main) / sizeof(g_vs_main[0]), nullptr, &bd->pVertexShader) != S_OK)
        {
            return false;
        }
        ...
        if (bd->pd3dDevice->CreateInputLayout(local_layout, 3, g_vs_main, sizeof(g_vs_main) / sizeof(g_vs_main[0]), &bd->pInputLayout) != S_OK)
        {
            return false;
        }
    ...
    {
        if (bd->pd3dDevice->CreatePixelShader(g_ps_main, sizeof(g_ps_main) / sizeof(g_ps_main[0]), nullptr, &bd->pPixelShader) != S_OK)
        {
            return false;
        }
    }
